...
FS_LIBS =  -lfuse3 -lpthread -lboost_system -lboost_filesystem -lboost_serialization -ldl -lbz2 -llz4 -lzstd -lz -lsnappy -l:/usr/lib/lib45d.a
ifdef DEB
FS_LIBS += -l:liburing.a
else
FS_LIBS += -luring
endif
CLI_LIBS = -l:libboost_system.a -l:libboost_filesystem.a -lpthread -l:/usr/lib/lib45d.a
CC = g++
